...
import { voidPaymentAction } from "@/modules/treasury/application/commands/treasury.commands";
import { getPaymentsPageData } from "@/modules/treasury/application/queries/get-treasury-page-data";
import { PaymentsPage } from "@/modules/treasury/ui/pages/payments-page";
...
export default async function TreasuryPaymentsRoutePage({
  params,
  searchParams,
}: {
  ...
  return (
    <PaymentsPage
      ...
      onVoid={voidPaymentAction.bind(null, organizationSlug)}
    />
  );
}
